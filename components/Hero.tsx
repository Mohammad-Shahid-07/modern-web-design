  ...
  return (
    <div className="flex max-xl:flex-wrap !overflow-x-hidden justify-center items-center ">
      <div className=" xl:ml-16 max-xl:px-5 ">
        ...
        <p className="text-[#E8E8E8] text-xl text-center">
          Lorem ipsum dolor sit amet lorem
        </p>
        <Button className="bg-btn px-4 py-6 rounded-full mt-5 mx-auto flex  ">
          Start your free trial <ArrowRight className="w-4 h-5 ml-2" />{" "}
        </Button>
      </div>
      <div className="xl:translate-x-4 max-xl:px-10 mt-16">
        <Image
